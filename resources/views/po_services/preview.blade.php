                ...
                <div class="col-6">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <th>Tax (10 %)</th>
                                <td>{{ $po->is_vat ? number_format($item_services->sum('sub_total') * 0.11, 2) : '-' }}
                                </td>
                            </tr>
                            <tr>
                                <th>Total:</th>
                                <td>
                                    {{ $po->is_vat
                                        ? number_format($item_services->sum('sub_total') * 1.11, 2)
                                        : number_format($item_services->sum('sub_total'), 2) }}
                                </td>
                            </tr>
                        </table>
                    </div>
