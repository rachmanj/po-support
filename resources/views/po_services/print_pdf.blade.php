                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tr>
                                ...
                                <td>{{ number_format(isset($item_services) && $item_services->count() > 0 ? $item_services->sum('sub_total') : 0, 2) }}
                                </td>
                            </tr>
                            <tr>
                                <th>Tax (11 %)</th>
                                <td>{{ isset($po->is_vat) && $po->is_vat ? number_format(isset($item_services) && $item_services->count() > 0 ? $item_services->sum('sub_total') * 0.11 : 0, 2) : '-' }}
                                </td>
                            </tr>
                            <tr>
                                <th>Total:</th>
                                <td>{{ isset($po->is_vat) && $po->is_vat ? number_format(isset($item_services) && $item_services->count() > 0 ? $item_services->sum('sub_total') * 1.11 : 0, 2) : number_format(isset($item_services) && $item_services->count() > 0 ? $item_services->sum('sub_total') : 0, 2) }}
                                </td>
                            </tr>
                        </table>
